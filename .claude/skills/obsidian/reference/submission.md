...
*Repo note: for this plugin's actual release checklist and PR flow against `obsidian-releases`, see `.claude/docs/OBSIDIAN_PLUGIN_SUBMISSION_GUIDE.md` — it's the authoritative, repo-specific version of the general guidance below.*
